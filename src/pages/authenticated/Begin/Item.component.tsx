...
const Item: React.FC<Props> = ({ isAdd = false, addItem = () => {}, editItem = () => {}, deleteItem = () => {} }) => {
  ...
  return (
    <ItemElement className={isAdd ? "btn-add" : ""} onClick={() => (isAdd && addItem ? addItem() : undefined)}>
      <div className="content">
        {isAdd ? (
          ...
          <>
            ...
            <button className={`btn-menu${menuOpened ? " active" : ""}`} onClick={() => setMenuOpened(!menuOpened)}>
